...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		stars.setBounds(722, 370, 150, 100);
		stars.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagenes/stars.png")));
		panel.add(stars);
		...
		btnLogin.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseEntered(MouseEvent e) {
				imagenLogin.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagenes/user.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
