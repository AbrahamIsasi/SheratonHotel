...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(Long idReserva) {
		...
		imagenFondo.setBounds(5, 12, 479, 600); //121-479-502
		panel.add(imagenFondo);
		imagenFondo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/imagenes/registro.png")));
		/*
		JLabel logo = new JLabel("");
		logo.setBounds(170, 60, 150, 60); //194-39-104-107
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHuesped.class.getResource("/imagenes/Ha-115px.png")));
		*/
